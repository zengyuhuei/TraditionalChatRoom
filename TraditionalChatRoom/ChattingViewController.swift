...
class ChattingViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let myTableView = UITableView(frame: CGRect(x: 0, y: 20, width: fullScreenSize.width, height: fullScreenSize.height - 400), style: .grouped)
        //建立text
        let textView = UITextView(frame: CGRect(x: 0, y: fullScreenSize.height-400, width: fullScreenSize.width, height:200))
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.imageView?.image = UIImage(named: "003.png")
        return cell
    }
